      ...
      <div className="container">
        <section className="card p-8 max-w-xl mx-auto">
          ...
          <p className="mt-1 text-sm text-[rgba(100,116,139,0.95)]">
            Your notes will be private to your account.
          </p>
          ...
          <form className="mt-6 space-y-4" onSubmit={onSubmit}>
            ...
            <button className="button button-accent w-full" disabled={busy} type="submit">
              {busy ? "Creating…" : "Create account"}
            </button>
          </form>

          <div className="mt-6 flex items-center justify-between text-sm">
            <Link className="text-[rgba(59,130,246,0.95)] hover:underline" href="/login">
